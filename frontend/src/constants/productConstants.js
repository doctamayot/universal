...
export const NEW_WAIT_REQUEST = 'NEW_WAIT_REQUEST';
export const NEW_WAIT_SUCCESS = 'NEW_WAIT_SUCCESS';
export const NEW_WAIT_RESET = 'NEW_WAIT_RESET';
export const NEW_WAIT_FAIL = 'NEW_WAIT_FAIL';

export const GET_WAITINGS_REQUEST = 'GET_WAITINGS_REQUEST';
export const GET_WAITINGS_SUCCESS = 'GET_WAITINGS_SUCCESS';
export const GET_WAITINGS_FAIL = 'GET_WAITINGS_FAIL';

export const DELETE_WAIT_REQUEST = 'DELETE_WAIT_REQUEST';
export const DELETE_WAIT_SUCCESS = 'DELETE_WAIT_SUCCESS';
export const DELETE_WAIT_RESET = 'DELETE_WAIT_RESET';
export const DELETE_WAIT_FAIL = 'DELETE_WAIT_FAIL';
